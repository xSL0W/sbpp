 ...
 */
$serverip   = "185.106.122.130";
$serverport = 27015;
$serverrcon = "7a89fjasf8iajsf9"; // You only need to specify this, if you want to test the rcon tcp connection either! Leave blank if it's only the serverinfo erroring.
